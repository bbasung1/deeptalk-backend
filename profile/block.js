...
router.post("/list", async (req, res) => {
    ...
    const content = await knex("block_list").select("block_list.blocked_user_id","profile.nickname","profile.user_id","profile.image").leftJoin("profile", "block_list.blocked_user_id", "profile.id").where({ "block_list.user_id": ourid, "block_list.type": TYPE_BLOCK });
    console.log(content);
